...
const NavBar = () => {
  ...
  return (
    <div className='flex  justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-black bg-red'>
      ...
      <ul className='hidden md:flex cursor-pointer text-gray-600'>
        {Links.map((link) => (
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-200 bg-white ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
        ...
        <li className='p-4 border-b border-gray-200 hover:text-[#FF8343]'><a>Dashboard</a></li>
        <li className='p-4 border-b border-gray-200 hover:text-[#FF8343]'><a>Profile</a></li>
        <li className='p-4 hover:text-[#FF8343]'><a>Contact & FAQ</a></li>
      </ul>
