...
const GoalList: FunctionComponent<GoalListProps> = ({ formName, description, GoalList }) => {
  ...
  const calculatePercentage = (current: number | undefined, target: number | undefined) => {
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 py-1">{goal.description}</p>
                  </div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {calculatePercentage(goal.currentAmount, goal.targetAmount)}% completed
                </p>
              </li>
            ))}
          </ul>
